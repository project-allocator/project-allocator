...
export class ShortlistService {
   ...
   * @throws ApiError
   */
  public static isShortlisted(projectId: number): CancelablePromise<boolean> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static setShortlisted(projectId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "POST",
      url: "/api/users/me/shortlisted/{project_id}",
      path: {
   ...
   * @throws ApiError
   */
  public static unsetShortlisted(projectId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
      url: "/api/users/me/shortlisted/{project_id}",
      path: {
