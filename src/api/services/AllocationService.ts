...
export class AllocationService {
   ...
   * @throws ApiError
   */
  public static removeAllocatee(userId: number): CancelablePromise<any> {
    return __request(OpenAPI, {
      method: "DELETE",
   ...
   * @throws ApiError
   */
  public static isAllocated(projectId: number): CancelablePromise<boolean> {
    return __request(OpenAPI, {
      method: "GET",
   ...
   * @throws ApiError
   */
  public static readConflictingProjects(): CancelablePromise<
    Array<ProjectRead>
  > {
    return __request(OpenAPI, {
      method: "GET",
