  ...
  return (
    <>
      ...
      <Paragraph className="text-slate-500">
        Click this to notify staff about the approval of their project proposals via email and in-app notification.
        The emails will be sent from your Microsoft account.
      </Paragraph>
      <Button
        icon={<SendOutlined />}
      ...
      <Paragraph className="text-slate-500">
        Click this to notify students about the project allocation via email and in-app notification.
        The emails will be sent from your Microsoft account.
      </Paragraph>
      <Button
        icon={<SendOutlined />}
      ...
      <Paragraph className="text-slate-500">
        Click this to notify your choice of users with a custom message via email and in-app notification.
        The emails will be sent from your Microsoft account.
      </Paragraph>
      <Form
        method="post"
